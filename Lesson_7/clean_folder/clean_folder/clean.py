...
def programs_folder(files, path):
...
def main():
    ...
    recursive_func(path)
    docs_folder(files, path)
    audio_folder(files, path)
    video_folder(files, path)
    images_folder(files, path)
    archive_folder(files, path)
    programs_folder(files, path)
